    ...
    return(
       <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
        <div className="flex flex-col">
            <label text-sm htmlFor="name">Nome</label>
        ...
        <div className="flex flex-col">
            <label text-sm htmlFor="email">E-mail</label>
            <input type="email" placeholder="Digite o seu email" className="rounded-lg py-2 px-2 text-sm placeholder:text-sm placeholder:text-stone-400" value={email} onChange={(e) => setEmail(e.target.value)}/>
        ...
        <div className="flex flex-col">
            ...
            <div className="flex gap-2 items-center">
                <input type="checkbox"  value={name} checked={agree} onChange={(e) => setAgree(e.target.checked)}/>
                <label text-sm htmlFor="agree">concorde com os termos</label>
            </div>
